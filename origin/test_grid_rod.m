...
depth = 0.5;%do chon sau
%d_x = [10 10];%kich thuoc luoi theo phuong ngang
%d_y = [10 10];%kich thuoc luoi theo phuong doc
d_x =ones(1,1)*10;%kich thuoc luoi theo phuong ngang
d_y =ones(1,1)*10;%kich thuoc luoi theo phuong doc
...
grid on;
save('ket_qua_luoi_11RBF.mat','tv','uv');
pause; 
hold off; %l?nh này vé trên d? li?u s?ch m?i, b?t on thì v? trên d? li?u c?
